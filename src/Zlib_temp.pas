{*****************************************************************************
*  ZLib.pas                                                                  *
*  copyright (c) 2000 base2 technologies                                     *
...
function deflateInit_(var strm: TZStreamRec; level: Integer; version: PChar;
  recsize: Integer): Integer; cdecl; external 'zlib1.dll' name 'deflateInit_';

function deflate(var strm: TZStreamRec; flush: Integer): Integer; cdecl;
  external 'zlib1.dll' name 'deflate';

function deflateEnd(var strm: TZStreamRec): Integer; cdecl;
  external 'zlib1.dll' name 'deflateEnd';
{$ELSE}
function deflateInit_(var strm: TZStreamRec; level: Integer; version: PChar;
