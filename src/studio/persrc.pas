...
begin
   ...
   begin
      ...
      TLogUtils.Info('Adjusting size by ' + IntToStr(Adjustment));
...
procedure TResourceTreeNode.Unpack(Resource_Offset : dword; Section_Address : dword; F : TBinaryFile);
   ...
   begin
      ...
      F.BlockRead2(PWideChar(Result), len * sizeof(WideChar));
   end;
      ...
      begin
         ...
         begin
            ...
            begin
               ...
               BlockWrite(PWideChar(ChildNode.name), Length(ChildNode.name) * sizeof(WideChar));
