...
const
 ...
 FSCTL_LOCK_VOLUME        = $00090018;  // CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 6, METHOD_BUFFERED, FILE_ANY_ACCESS)
 FSCTL_UNLOCK_VOLUME      = $0009001C;  // CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 7, METHOD_BUFFERED, FILE_ANY_ACCESS)
 FSCTL_DISMOUNT_VOLUME    = $00090020;  // CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 8, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
//
  ...
  PDISK_GEOMETRY_EX = ^TDISK_GEOMETRY_EX;
   ...
   TRAW_READ_INFO = record
    ...
    SectorCount   : ULONG    ;
    TrackMode     : Integer;//TRACK_MODE_TYPE ;
   end;
   PRAW_READ_INFO = ^TRAW_READ_INFO;
...
// ATA/ATAPI PASS THROUGH constants for SMART
const
  ...
  // ATA commands
  ATA_SMART_CMD = $B0;
  SMART_READ_VALUES = $D0;
  SMART_READ_THRESHOLDS = $D1;
