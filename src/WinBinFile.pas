{******************************************************************************}
{                                                                              }
{  ImageWriter - Windows Binary File Operations Unit                          }
{                                                                              }
...
{  Original: $Header: /home/cso/jnewbigin/cvsroot/rawwrite/WinBinFile.pas     }
{                                                                              }
...
{                                                                              }
{  Description:                                                                }
{    Windows-specific implementation of binary file operations.               }
{    Handles device access, file I/O, and block operations.                   }
{                                                                              }
{******************************************************************************}
...
begin
   ...
   F := CreateFile(PChar(FileName), OpenMode, ShareMode, nil, OPEN_EXISTING, FILE_FLAG_SEQUENTIAL_SCAN, 0);
...
begin
   F := CreateFile(PChar(FileName), GENERIC_READ or GENERIC_WRITE, 0, nil, CREATE_NEW, FILE_FLAG_SEQUENTIAL_SCAN, 0);
   if F = INVALID_HANDLE_VALUE then
   begin
      IsOpen := False;
   end
...
// special CD testing
   ...
   RawRead.TrackMode := 0;
    ...
    if ( DeviceIoControl( F,             $2403E,//CtlCode(IOCTL_CDROM_BASE, $000F, METHOD_OUT_DIRECT, FILE_READ_ACCESS),
                          ...
                          Actual,        nil )) then
      begin
         TLogUtils.Debug('IOCTL_CDROM_RAW_READ worked');
      end
      else
      begin
         TLogUtils.Warning('IOCTL_CDROM_RAW_READ failed');
